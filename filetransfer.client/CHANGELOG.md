...
- Create Angular project with ng: `ng new "filetransfer.client" --defaults --skip-install --skip-git --no-standalone `.
...
- Update app.ts component to fetch and display file transfer information.
- Modify app.spec.ts with updated tests.
- Update app-module.ts to import the HttpClientModule.
- Create project file (`filetransfer.client.esproj`).
